...
Without importing modules or using type(). 2. Print and count integers
...
Without importing modules or using len(). 3. Integers division with debug
...
Without importing modules. 4. Divide a list
...
Without importing modules. 5. Raise exception

5-raise_exception.py: Python function that raises a type exception.
Without importing modules. 6. Raise a message

6-raise_exception_msg.py: Python function that raises a name exception with a message.
Without importing modules. 7. Safe integer print with error message
...
Without importing modules. 8. Safe function
...
Otherwise, prints an en exception error to stderr and returns None. 9. ByteCode -> Python #4
